...
set JARPATH=%APP_HOME%\lib\hun_test-1.0.0.jar

@rem Execute hun_test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HUN_TEST_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%HUN_TEST_EXIT_CONSOLE%" exit 1
exit /b 1
